...
class Matrix2D:
    def __init__(self, *a):
        if len(a) == 1:  # один параметр, але може в ньому бути або масив або інша матриця
            if isinstance(a[0], Matrix2D):
                self.a11, self.a12, self.a21, self.a22 = a[0].a11, a[0].a12, a[0].a21, a[0].a22
            elif len(a[0]) == 4:
                self.a11, self.a12, self.a21, self.a22 = a[0] 
            else:
                self.a11, self.a12 = a[0][0]
                self.a21, self.a21 = a[0][1]
